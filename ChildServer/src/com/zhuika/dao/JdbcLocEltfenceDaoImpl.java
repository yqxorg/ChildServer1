...
public class JdbcLocEltfenceDaoImpl implements ILocEltfenceDao {
	...
	public void addLocEltfence(LocElectfence locElectfenceInfo)
		...
		try {
			...
			sql.append(" INSERT INTO T_LOC_ELECTFENCE( FLocFenID,FEltFenceID,FSerialnumber,FDataStatus,FFieldStatus,FEltLongitude,FEltLatitude,FEltScope,FEltAddress,FLongitude,FLatitude,FAddress,FDistance,FAddTime,FUpdateTime,FRemark ) ");
			sql.append(" values(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)");
